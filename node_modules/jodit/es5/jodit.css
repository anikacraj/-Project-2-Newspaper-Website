...
.jodit-ui-tooltip {
  ...
  -webkit-box-shadow: 0 0 0 0 #e5e5e5, 0 8px 20px 0 rgba(0, 0, 0, 0.15);
          box-shadow: 0 0 0 0 #e5e5e5, 0 8px 20px 0 rgba(0, 0, 0, 0.15);
  color: #fff;
  font-family: -apple-system, blinkmacsystemfont, 'Segoe UI', roboto,
		oxygen-sans, ubuntu, cantarell, 'Helvetica Neue', sans-serif;
  font-size: 11px;
  ...
  -webkit-transform: translate(-50%, calc(8px / 2));
      -ms-transform: translate(-50%, calc(8px / 2));
          transform: translate(-50%, calc(8px / 2));
...
.jodit-ui-tooltip__content {
  padding: calc(8px / 2) calc(8px * 1.5);
}
...
.jodit-tabs .jodit-tabs__buttons .jodit-ui-button:active:not([disabled]) {
  -webkit-box-shadow: 0 0 #0000, 0 1px 3px 0 rgba(0, 0, 0, 0.1),
		0 1px 2px -1px rgba(0, 0, 0, 0.1);
          box-shadow: 0 0 #0000, 0 1px 3px 0 rgba(0, 0, 0, 0.1),
		0 1px 2px -1px rgba(0, 0, 0, 0.1);
  color: rgba(0, 0, 0, 0.75);
}
